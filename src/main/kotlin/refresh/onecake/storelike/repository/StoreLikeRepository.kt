package refresh.onecake.storelike.repository

import org.springframework.data.jpa.repository.JpaRepository
import org.springframework.data.jpa.repository.Query
import org.springframework.stereotype.Repository
import refresh.onecake.storelike.dto.LikedStore
...
interface StoreLikeRepository: JpaRepository<StoreLike, Long> {
    ...
    @Query(value = """
        select new refresh.onecake.storelike.dto.LikedStore(s.id, s.storeImage, s.storeName)
